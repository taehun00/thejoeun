...
public class ExecinfoController {
	...
	@GetMapping("/infowrite") public String write_get( Model model ) { 
	...
	public String delete_post( ExecinfoDto idto, RedirectAttributes rttr) {
		String result ="글삭제에 실패했습니다.";
		if(iservice.deleteinfo(idto) > 0) { result="글삭제에 성공했습니다!";}
		rttr.addFlashAttribute("success" , result);
		return "redirect:/info/infolist";
	} 
}
