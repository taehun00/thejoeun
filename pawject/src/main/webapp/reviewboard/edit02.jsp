			...
			<div class="col-3">
		      ...
		      <div class="col-3 d-flex justify-content-end align-items-end mt-4">	
				...
				<button type="button" class="btn btn-beige"
        			onclick="location.href='<%=request.getContextPath()%>/list.do'">목록보기</button>
		      </div>	
		    </div>
		 <div class="row">
		    <!-- 제목 입력 -->
		    ...
		    <div class="mb-3">
		      ...
		      <textarea class="form-control" rows="5" id="reviewcomment" name="reviewcomment">${dto.reviewcomment}</textarea>
		    </div>
		  </form>
		</div>
