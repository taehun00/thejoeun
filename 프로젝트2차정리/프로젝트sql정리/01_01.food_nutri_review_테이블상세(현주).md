...
- 리뷰 작성(insert) : 	
	insert into review (reviewid, userid, nickname, brandid, foodid, foodimg, reviewimg rating, title, reviewcomment, createdat)
            values(review_seq.nextval, #{userid},#{nickname},#{brandid},#{foodid},#{foodimg}, #{reviewimg}, #{rating},#{title},#{reviewcomment}, sysdate)
