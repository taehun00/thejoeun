...
public class AdService {
    ...
    // 광고 작성
    public AdResponseDto createAd(Long userId, AdRequestDto dto, MultipartFile file) {
        ...
        if (file != null && !file.isEmpty()) {
            String storedPath = fileStorageService.upload(file);
    ...
    // 광고 수정
    public AdResponseDto updateAd(Long userId, Long adId, AdRequestDto dto, MultipartFile file) {
        Ad ad = adRepository.findById(adId)
                .orElseThrow(() -> new RuntimeException("Ad not found"));
