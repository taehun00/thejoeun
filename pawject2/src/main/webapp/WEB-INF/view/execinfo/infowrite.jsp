...
<%@include file="../inc/header.jsp" %> 
   <div class="container card  my-5 p-4">
	  ...
	  <form action="${pageContext.request.contextPath}/write.execboard"  
...
>>>>>>> 8229c01e4a164a1e7969c039b4ee1bd00d7c3dde
		  ...
		  <div class="mb-3">
		    ...
		    <input type="text" class="form-control"  placeholder="내용을 입력해주세요" id="avgkcal30min" name="avgkcal30min">
		  </div>
		  <div class="mb-3 mt-3">
		  ...
		  <div class="mb-3 mt-3">
		    ...
		    <input type="text" class="form-control" placeholder="운동유형 입력해주세요" id="suitablefor"  name="suitablefor">
		  </div>
		  <div class="mb-3">
		    <label for="intensitylevel" class="form-label">운동강도:</label>
		    <input type="text" class="form-control" id="intensitylevel" placeholder="이미지를 선택해주세요" name="intensitylevel">
		  </div>
		  
		  <div class="mb-3  text-end">
		  	<button type="submit" class="btn btn-terra">글쓰기</button>  
		  	<a href="${pageContext.request.contextPath}/list.execinfo"  class="btn btn-slateblue">목록보기</a>
		  </div>
